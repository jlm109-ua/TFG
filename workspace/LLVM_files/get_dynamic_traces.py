# This file has to be located at ../LLVM-Tracer/playground/.
...
def alreadyProcessed(file,path):
    ...
    ### Problemas de los kernels listados a continuación:
    #
    # "OptimalPolygon"
    # "FactorialArray"
    # "MatrixLand"
    # "OrderStrings"
    # "ChocolateFeast":         Bucle infinito de 0s.
    # "FroginMaze":             La traza dinámica pesa casi 8GB.
    # "DivisorExploration3"     Se queda colgado.
    # "PolynomialDivision"      Segmentation fault.
    # "ExtraSweet"              Segmentation fault.
    # "CarShow"                 Segmentation fault.
    # "SuffixRotation"          Bucle infinito de 1001s.
    # "TheGreatGameofGalia"     Segmentation fault.
    # "AngryProfessor"          Error executing kernel AngryProfessor.
    # "HighwayConstruction"     Error executing kernel HighwayConstruction.
    # "icecreamparlour"         La traza dinámica pesa 12,5GB
    # "DistantPairs"            Error executing kernel DistantPairs.
    # "CardsPermutation"        Error executing kernel CardsPermutation.
    # "AlternatingCharacters"   Error executing kernel AlternatingCharacters.
    if file.name == "OptimalPolygon" or file.name == "FactorialArray" or file.name == "MatrixLand" or file.name == "OrderStrings" or file.name == "ChocolateFeast" or file.name == "FroginMaze" or file.name == "DivisorExploration3" or file.name == "PolynomialDivision" or file.name == "ExtraSweet" or file.name == "CarShow" or file.name == "SuffixRotation" or file.name == "TheGreatGameofGalia" or file.name == "AngryProfessor" or file.name == "HighwayConstruction" or file.name == "icecreamparlour" or file.name == "DistantPairs" or file.name == "CardsPermutation" or file.name == "AlternatingCharacters":
        return True
